      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center justify-end gap-2 sm:gap-3 flex-shrink-0">
            <a href="https://forms.gle/y4zYUA6unAkzsWah6" target="_blank" rel="noopener noreferrer" className="px-3 sm:px-4 py-2 rounded-lg bg-[var(--accent-primary)] dark:bg-[var(--accent-primary)] text-white hover:bg-[var(--accent-secondary)] dark:hover:bg-[var(--accent-secondary)] transition-all text-sm lg:text-base font-body font-semibold shadow-lg hover:shadow-xl hover:scale-105 whitespace-nowrap">
              Leave feedback
            </a>
          </div>
        </div>
